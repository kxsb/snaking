### Code en état de développement chronique - non fonctionnel en l'espèce ##
...
snake_brain.py : [transitoire > devient > 'snake_AIview.py'] Actuellement : contient les fonctions pour initialiser et entraîner l'agent Snake, en utilisant le modèle DQN. Est similaire à snake_train.py, à la différence de l'affichage graphique. 
...
Utils.py : stocke les utilitaires, et est notamment utilisées pour faciliter l'entraînement et le suivi des performances du modèle.
