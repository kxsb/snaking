...
import json
import os
from snake import lancer_snake  # Importer la fonction lancer_snake depuis snake.py
...
def lancer_ai_games_interface():
    pygame.quit()  # Fermer Pygame avant d'ouvrir Tkinter
...
def menu_principal():
    ...
    afficher_texte("Welcome young", 250, 50)
