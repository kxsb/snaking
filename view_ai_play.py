...
class ViewAIPlay:
    def __init__(self, model_path=None):
        ...
        self.model = SnakeAgent(env_type='full').model
        ...
        self.env = SnakeEnv()  # Utiliser SnakeEnv pour gérer l'environnement du jeu
        self.clock = pygame.time.Clock()

        # Initialisation de la vitesse et de la grille
        self.ticks_per_frame = 20
        self.grid_size = GRID_SIZES[0]  # Taille par défaut de la grille
